...
async function main() {
    ...
    const cardTemplateTabFieldData = [
        ...
        {
            data: "Checkboxes label;key1:value1,key2:value2,key 3:value 3;0;",
            posX: 1,
            posY: 2,
            cardTemplateTabId: 2,
            fieldTypeId: 6,
        ...
        {
            data: "Drop down label;drop1:value,drop2:value2,drop 3:value 3;0;",
            posX: 1,
            posY: 3,
            cardTemplateTabId: 2,
            fieldTypeId: 7,
        ...
        {
            data: "Severity;1:critical,2:major,3:minor;0;",
            posX: 1,
            posY: 1,
            cardTemplateTabId: 3,
            fieldTypeId: 7,
        ...
        {
            data: "Affected areas;1:dev,2:staging,3:production;0;",
            posX: 2,
            posY: 1,
            cardTemplateTabId: 3,
            fieldTypeId: 6,
        ...
        {
            data: "Client contact information;;0;",
            posX: 1,
            posY: 3,
            cardTemplateTabId: 3,
            fieldTypeId: 2,
        ...
        {
            data: "Steps to reproduce bug, expected and actual results;;0;",
            posX: 2,
            posY: 3,
            cardTemplateTabId: 3,
            fieldTypeId: 2,
        ...
        {
            data: "Single line w/o placeholder required;;1;Single line error message",
            posX: 1,
            posY: 3,
            cardTemplateTabId: 5,
            fieldTypeId: 1,
        ...
        {
            data: "Muli line w/o placeholder required;;1;Multiline error message",
            posX: 2,
            posY: 3,
            cardTemplateTabId: 5,
            fieldTypeId: 2,
